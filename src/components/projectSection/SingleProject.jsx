  ...
  return (
    ...
    >
      <div >
        ...
        <a
          href={link}
          className={`text-lg flex gap-2 items-center text-cyan-500 hover:text-amber-400 transition-all duration-500 cursor-pointer sm:flex sm:justify-self-center ${align === "left" ? "md:justify-self-end" : "md:justify-self-start"
            }`}
        >
      ...
      >
        ...
        <img src={image} alt="project all" className="w-full h-full" />
      </div>
    </motion.div>
  );
};
